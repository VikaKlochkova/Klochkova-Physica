...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="css/style-g.css">
  <meta charset="UTF-8">
...
<!--Заглавие сайта-->
  <header>
	<div id="header">
	   <h3><strong><font color="white">Предложения :) </font></strong></h3>  
<!---->
<!--меню сайта-->
<div>
      <ul>
...
<!-- Область Контента -->
<div id="content">
<b>Ваши предложения помогут админу исправить сайт в лучшую сторону)))</b>
<form>
